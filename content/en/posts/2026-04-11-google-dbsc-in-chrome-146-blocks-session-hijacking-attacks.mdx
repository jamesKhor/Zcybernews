...
date: '2026-04-11'
excerpt: >-
  Google's Device Bound Session Credentials (DBSC) in Chrome 146
  cryptographically binds session cookies to devices, neutralizing infostealing
  malware that steals cookies to hijack accounts.
category: tools
tags:
