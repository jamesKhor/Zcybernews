...
date: '2026-04-12'
excerpt: >-
  A criminal group deployed the self-propagating CanisterWiper malware against
  Iranian entities, exploiting misconfigured cloud storage to spread and destroy
  data.
category: malware
tags:
  - canisterwiper
